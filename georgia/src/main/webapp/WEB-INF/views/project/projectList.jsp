...
<table id="pro__search__table">
	...
	<tbody>
		<tr>
			<td><input type="date" name="startDate" id="startDate" min="2010-07-01" max="2025-06-30" class="s__pro"></td>
			<td><input type="date" name="endDate" id="startDate" min="2010-07-01" max="2025-06-30" class="s__pro"></td>
			<td>
