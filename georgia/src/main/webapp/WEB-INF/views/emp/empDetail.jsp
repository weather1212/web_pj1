			...
			<form role="form" id="detailForm" name="detailForm" method="post">
				<table>
					<tbody>
						...
						<tr>
							<td><label for="emp_profit">업무 실적</label> <input type="text"
									id="emp_profit" name="emp_profit" value="${empVO.emp_profit}" /></td>
						</tr>
						<tr>
							<td><label for="emp_salary">사원 급여</label> <input type="text"
									id="emp_salary" name="emp_salary" value="${empVO.emp_salary}" /></td>
						</tr>
						<tr>
							<td><label for="emp_state">재직 여부</label> <input type="text"
